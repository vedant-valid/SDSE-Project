    ...
    <div className="min-h-screen bg-void flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        ...
        <div className="bg-surface border border-gold/20 p-8">
          <p className="text-xs tracking-[3px] uppercase text-amber mb-1">नया खाता</p>
          <h1 className="font-serif text-2xl text-amber mb-6">Create Account</h1>
          ...
          <p className="text-cosmic text-sm text-center mt-6">
            ...
            <Link href="/auth/signin" className="text-amber hover:text-gold transition-colors">
              Sign in
            </Link>
          </p>
        </div>
